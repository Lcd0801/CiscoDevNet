...
curl -k -X POST -F 'username=alice' -F 'password=myalicepassword' 'https://localhost:5000/signup/v1' 

curl -k -X POST -F 'username=bob' -F 'password=passwordforbob' 'https://localhost:5000/signup/v1' 

curl -k -X POST -F 'username=alice' -F 'password=myalicepassword' 'https://localhost:5000/login/v1' 

curl -k -X POST -F 'username=bob' -F 'password=passwordforbob' 'https://localhost:5000/login/v1' 

 

curl -k -X POST -F 'username=rick' -F 'password=samepassword' 'https://localhost:5000/signup/v2' 

curl -k -X POST -F 'username=allan' -F 'password=samepassword' 'https://localhost:5000/signup/v2' 

curl -k -X POST -F 'username=dave' -F 'password=differentpassword' 'https://localhost:5000/signup/v2' 

curl -k -X POST -F 'username=rick' -F 'password=samepassword' 'https://localhost:5000/login/v2' 

curl -k -X POST -F 'username=allan' -F 'password=samepassword' 'https://localhost:5000/login/v2' 

curl -k -X POST -F 'username=dave' -F 'password=differentpassword' 'https://localhost:5000/login/v2' 
